...
def save_all_figures_and_report(result, gui, save_dir):
    ...
    with open(report_path, "w") as f:
        ...
        f.write(f"ELA: {gui.param_vars[3].get()}\n")
        f.write(f"Max Gain (Accumulation Zone): {gui.param_vars[4].get()}\n")
        f.write(f"Max Loss (Accumulation Zone): {gui.param_vars[5].get()}\n")
        f.write(f"Max Gain (Ablation Zone): {gui.param_vars[6].get()}\n")
        f.write(f"Max Loss (Ablation Zone): {gui.param_vars[7].get()}\n")
        f.write("\n")
